...
//
//template<typename KeyType, typename ValueType>
//HashTable::Iterator HashTable<KeyType, ValueType>::begin() {
//    return HashTable::Iterator(__gnu_cxx::__normal_iterator(), __gnu_cxx::__normal_iterator());
//}
//
//template<typename KeyType, typename ValueType>
//HashTable::Iterator HashTable<KeyType, ValueType>::end() {
//    return HashTable::Iterator(__gnu_cxx::__normal_iterator(), __gnu_cxx::__normal_iterator());
//}
//
//template<typename KeyType, typename ValueType>
